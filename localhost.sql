...
-- Database: `next_level`
--
CREATE DATABASE IF NOT EXISTS `next_level` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `next_level`;
...
(27, 'blue-wallpaper-25.jpg', 'RE Village BRKSEDU', 'Bilada', '2021-05-07 14:00:00', '_awtinIprAk');
...
(18, 24, 1, '2021-05-06 09:56:23'),
(19, 25, 1, '2021-05-06 09:56:26'),
(20, 26, 1, '2021-05-06 12:24:37');
...
--
ALTER TABLE `conteudo`
  MODIFY `id_conteudo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
('root', '[{\"db\":\"next_level\",\"table\":\"conteudoaluno\"},{\"db\":\"next_level\",\"table\":\"usuarios\"}]');
...
('root', '2021-05-07 15:41:53', '{\"Console\\/Mode\":\"collapse\"}');
